...
local status_effect_list_fields = {
  ...
  max_mp       = ProtoField.uint32("ffxiv_ipc_status_effect_list.max_mp", "MaxMP", base.DEC),
  current_mp   = ProtoField.uint32("ffxiv_ipc_status_effect_list.current_mp", "CurrentMP", base.DEC),
  current_tp   = ProtoField.uint32("ffxiv_ipc_status_effect_list.current_tp", "CurrentTP", base.DEC),
  unknown1     = ProtoField.uint32("ffxiv_ipc_status_effect_list.unknown1", "Unknown1", base.DEC),
  status_id    = ProtoField.uint32("ffxiv_ipc_status_effect_list.status_id", "StatusID", base.DEC),
  status_extra = ProtoField.uint32("ffxiv_ipc_status_effect_list.status_extra", "StatusExtra", base.DEC),
  duration     = ProtoField.uint32("ffxiv_ipc_status_effect_list.duration", "Duration", base.DEC),
