...
local add_status_effect_fields = {
  ...
  unknown1            = ProtoField.uint32("ffxiv_ipc_add_status_effect.unknown1", "Unknown1", base.DEC),
  unknown2            = ProtoField.uint32("ffxiv_ipc_add_status_effect.unknown2", "Unknown2", base.DEC),
  current_hp          = ProtoField.uint32("ffxiv_ipc_add_status_effect.current_hp", "CurrentHP", base.DEC),
  current_mp          = ProtoField.uint32("ffxiv_ipc_add_status_effect.current_mp", "CurrentMP", base.DEC),
  current_tp          = ProtoField.uint32("ffxiv_ipc_add_status_effect.current_tp", "CurrentTP", base.DEC),
  max_hp              = ProtoField.uint32("ffxiv_ipc_add_status_effect.max_hp", "MaxHP", base.DEC),
  max_mp              = ProtoField.uint32("ffxiv_ipc_add_status_effect.max_mp", "MaxMP", base.DEC),
  count               = ProtoField.uint32("ffxiv_ipc_add_status_effect.count", "Count", base.DEC),
  unknown3            = ProtoField.uint32("ffxiv_ipc_add_status_effect.unknown3", "Unknown3", base.DEC),
  unknown4            = ProtoField.uint32("ffxiv_ipc_add_status_effect.unknown4", "Unknown4", base.DEC),
  status_id           = ProtoField.uint32("ffxiv_ipc_add_status_effect.status_id", "StatusID", base.DEC),
  status_extra        = ProtoField.uint32("ffxiv_ipc_add_status_effect.status_extra", "StatusExtra", base.DEC),
  unknown1            = ProtoField.uint32("ffxiv_ipc_add_status_effect.unknown1", "Unknown1", base.DEC),
  duration            = ProtoField.uint32("ffxiv_ipc_add_status_effect.duration", "Duration", base.DEC),
...
function ffxiv_ipc_add_status_effect.dissector(tvbuf, pktinfo, root)
  ...
  tree:add_le(add_status_effect_fields.duration, duration_tvbr)

  -- dissect the actor_id field
  local actor_id_tvbr = tvbuf:range(10, 4)
  local actor_id_val  = actor_id_tvbr:le_uint()
  tree:add_le(add_status_effect_fields.actor_id, actor_id_tvbr)
