...
local ffxiv_ipc_npc_spawn = Proto("ffxiv_ipc_npc_spawn", "FFXIV-IPC NpcSpawn")

local npc_spawn_fields = {
  title             = ProtoField.uint16("ffxiv_ipc_npc_spawn.title", "title", base.DEC),
  current_world_id  = ProtoField.uint16("ffxiv_ipc_npc_spawn.current_world_id", "currentWorldId", base.DEC),
  home_world_id     = ProtoField.uint16("ffxiv_ipc_npc_spawn.home_world_id", "homeWorldId", base.DEC),
  ...
  target_id         = ProtoField.bytes("ffxiv_ipc_npc_spawn.target_id", "targetId", base.NONE),
  main_weapon_model = ProtoField.bytes("ffxiv_ipc_npc_spawn.main_weapon_model", "mainWeaponModel", base.NONE),
  sec_weapon_model  = ProtoField.bytes("ffxiv_ipc_npc_spawn.sec_weapon_model", "secWeaponModel", base.NONE),
  craft_tool_model  = ProtoField.bytes("ffxiv_ipc_npc_spawn.craft_tool_model", "craftToolModel", base.NONE),
  b_npc_base        = ProtoField.uint32("ffxiv_ipc_npc_spawn.b_npc_base", "bNPCBase", base.DEC),
  b_npc_name        = ProtoField.uint32("ffxiv_ipc_npc_spawn.b_npc_name", "bNPCName", base.DEC),
  ...
  owner_id          = ProtoField.uint32("ffxiv_ipc_npc_spawn.owner_id", "ownerId", base.DEC),
  parent_actor_id   = ProtoField.uint32("ffxiv_ipc_npc_spawn.parent_actor_id", "parentActorId", base.DEC),
  hp_max            = ProtoField.uint32("ffxiv_ipc_npc_spawn.hp_max", "hpMax", base.DEC),
  hp_cur            = ProtoField.uint32("ffxiv_ipc_npc_spawn.hp_cur", "hpCur", base.DEC),
  ...
  mp_cur            = ProtoField.uint16("ffxiv_ipc_npc_spawn.mp_cur", "mpCur", base.DEC),
  tp_cur            = ProtoField.uint16("ffxiv_ipc_npc_spawn.tp_cur", "tpCur", base.DEC),
  mp_max            = ProtoField.uint16("ffxiv_ipc_npc_spawn.mp_max", "mpMax", base.DEC),
  ...
  persistent_emote  = ProtoField.uint8("ffxiv_ipc_npc_spawn.persistent_emote", "persistentEmote", base.DEC),
  ...
  models            = ProtoField.int32("ffxiv_ipc_npc_spawn.models", "models", base.DEC),
  nickname          = ProtoField.string("ffxiv_ipc_npc_spawn.nickname", "nickname", base.UNICODE),
  look              = ProtoField.bytes("ffxiv_ipc_npc_spawn.look", "look", base.NONE),
...
function ffxiv_ipc_npc_spawn.dissector(tvbuf, pktinfo, root)
  ...
  tree:add_le(npc_spawn_fields.title, title_tvbr, title_val)
  ...
  tree:add_le(npc_spawn_fields.current_world_id, current_world_id_tvbr, current_world_id_val)
  ...
  tree:add_le(npc_spawn_fields.home_world_id, home_world_id_tvbr, home_world_id_val)
  ...
  tree:add(npc_spawn_fields.target_id, target_id_tvbr, target_id_val)
  ...
  tree:add(npc_spawn_fields.main_weapon_model, main_weapon_model_tvbr, main_weapon_model_val)
  ...
  tree:add(npc_spawn_fields.sec_weapon_model, sec_weapon_model_tvbr, sec_weapon_model_val)
  ...
  tree:add(npc_spawn_fields.craft_tool_model, craft_tool_model_tvbr, craft_tool_model_val)
  ...
  tree:add_le(npc_spawn_fields.owner_id, owner_id_tvbr, owner_id_val)
  ...
  tree:add_le(npc_spawn_fields.hp_max, hp_max_tvbr, hp_max_val)

  -- dissect the hp_cur field
  local hp_cur_tvbr = tvbuf:range(96, 4)
  local hp_cur_val  = hp_cur_tvbr:le_uint()
  tree:add_le(npc_spawn_fields.hp_cur, hp_cur_tvbr, hp_cur_val)
  ...
  tree:add_le(npc_spawn_fields.persistent_emote, persistent_emote_tvbr, persistent_emote_val)
  ...
  while models_pos + models_len <= len do
    ...
    tree:add_le(npc_spawn_fields.models, models_tvbr, models_val)
