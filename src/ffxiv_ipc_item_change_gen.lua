...
local item_change_fields = {
  ...
  location   = ProtoField.uint32("ffxiv_ipc_item_change.location", "Location", base.DEC, item_location_valstr),
  position   = ProtoField.uint32("ffxiv_ipc_item_change.position", "Position", base.DEC),
  amount     = ProtoField.uint32("ffxiv_ipc_item_change.amount", "Amount", base.DEC),
  item       = ProtoField.uint32("ffxiv_ipc_item_change.item", "Item", base.DEC, db.Item),
  unknown1   = ProtoField.uint32("ffxiv_ipc_item_change.unknown1", "Unknown1", base.DEC),
  ...
  quality    = ProtoField.uint32("ffxiv_ipc_item_change.quality", "Quality", base.DEC, item_quality_valstr),
  attribute2 = ProtoField.uint32("ffxiv_ipc_item_change.attribute2", "Attribute2", base.DEC),
  condition  = ProtoField.uint32("ffxiv_ipc_item_change.condition", "Condition", base.DEC),
  spiritbond = ProtoField.uint32("ffxiv_ipc_item_change.spiritbond", "Spiritbond", base.DEC),
  unknown5   = ProtoField.uint32("ffxiv_ipc_item_change.unknown5", "Unknown5", base.DEC),
  glamour_id = ProtoField.uint32("ffxiv_ipc_item_change.glamour_id", "GlamourID", base.DEC),
