...
local status_effect_list_item_fields = {
  unknown0     = ProtoField.uint32("ffxiv_ipc_status_effect_list_item.unknown0", "Unknown0", base.DEC),
  current_hp   = ProtoField.uint32("ffxiv_ipc_status_effect_list_item.current_hp", "CurrentHP", base.DEC),
  max_hp       = ProtoField.uint32("ffxiv_ipc_status_effect_list_item.max_hp", "MaxHP", base.DEC),
  max_mp       = ProtoField.uint16("ffxiv_ipc_status_effect_list_item.max_mp", "MaxMP", base.DEC),
  current_mp   = ProtoField.uint16("ffxiv_ipc_status_effect_list_item.current_mp", "CurrentMP", base.DEC),
  current_tp   = ProtoField.uint16("ffxiv_ipc_status_effect_list_item.current_tp", "CurrentTP", base.DEC),
  unknown1     = ProtoField.uint16("ffxiv_ipc_status_effect_list_item.unknown1", "Unknown1", base.DEC),
  status_id    = ProtoField.uint16("ffxiv_ipc_status_effect_list_item.status_id", "StatusID", base.DEC),
  status_extra = ProtoField.uint16("ffxiv_ipc_status_effect_list_item.status_extra", "StatusExtra", base.DEC),
  duration     = ProtoField.float("ffxiv_ipc_status_effect_list_item.duration", "Duration", base.DEC),
  actor_id     = ProtoField.uint32("ffxiv_ipc_status_effect_list_item.actor_id", "ActorID", base.DEC),
}
...
function ffxiv_ipc_status_effect_list_item.dissector(tvbuf, pktinfo, root)
  ...
  tree:add_le(status_effect_list_item_fields.status_id, status_id_tvbr, status_id_val)

  -- dissect the status_extra field
  local status_extra_tvbr = tvbuf:range(2, 2)
  local status_extra_val  = status_extra_tvbr:le_uint()
  tree:add_le(status_effect_list_item_fields.status_extra, status_extra_tvbr, status_extra_val)
  ...
  tree:add_le(status_effect_list_item_fields.actor_id, actor_id_tvbr, actor_id_val)
