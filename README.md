...
The [forwarder](forwarder) can read raw packets from the game and send them to loopback udp ports. Therefore you can use Wireshark and this dissector
...
3. Enter `forwarder` directory, and run `yarn run build`.
